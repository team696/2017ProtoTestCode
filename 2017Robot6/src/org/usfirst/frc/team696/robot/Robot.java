...
public class Robot extends IterativeRobot {
	...
	public static DriveTrainSubsystem driveTrainSubsystem = new DriveTrainSubsystem(RobotMap.frontLeftMotor, RobotMap.rearLeftMotor, RobotMap.frontRightMotor, RobotMap.rearRightMotor);
	...
	public static GearIntakeFlapSubsystem gearIntakeFlapSubsystem = new GearIntakeFlapSubsystem(RobotMap.leftFlapServo, RobotMap.rightFlapServo);
...
//		Scheduler.getInstance().add(new PIXYAim());
	...
	public void teleopPeriodic() {
		...
		if(!closeGearFlap)gearIntakeFlapSubsystem.openPos();
		else gearIntakeFlapSubsystem.closePos();
